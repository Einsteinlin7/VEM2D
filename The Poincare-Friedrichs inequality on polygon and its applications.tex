%The final version by LS on Oct 10th, 2016
%The manuscript  by LS on Oct 8th, 2016
\documentclass[12pt]{article}
%%% The default page size is A4 piece of paper.
%%% In "[]", we can set the page size,also can set the font for your documents.
%%% \documentclass[11pt,a5paper]{article}
\usepackage{amsfonts}
\usepackage{amsmath}
%%%use (\usepackage[fleqn]{amsmath}) can change the formula that was center aligned into the left.
\usepackage{bm}
\usepackage{amssymb}
\usepackage{graphicx}
\usepackage{latexsym}
...
%%%Features: Makes two blank space at the beginning of each paragraph.
\usepackage{cite}
\usepackage{mathrsfs}
\usepackage{caption2}
\usepackage{CJK}
...
%%% added by Lin in the following
\usepackage{url}  %%% add underlining on a mailbox by "\_"
\usepackage{slashbox}
\usepackage[active]{srcltx}
\usepackage{verbatim} %add comments H
\usepackage{float}
\usepackage{times} %%% Sen added:Uncomment to use the Times New Roman font
\usepackage{tikz}  %%% figure
\usepackage{picinpar} %%%window,figwindow,tabwindow
%\DeclareMathOperator*{\argmin}{arg\,min}%% 自动底标了
%\synctex=0
...
%%%%%%% added by Einstein Lin
%%%%% Definition of the environmental category theorem %%%%
%\providecommand{\U}[1]{\protect\rule{.1in}{.1in}} \textwidth 15.2cm
%\textheight 23.4cm \hoffset -1.5cm \voffset -2.2cm
%%%%\newtheorem{theorem}{\bf Theorem}[section]
%%%% the added '[section]' means theorem numbered by section
...
%%\newenvironment{proof}[1][\bf Proof]{\textbf{#1.} }{}
%\newenvironment{question}[1][\bf\large Que]{\noindent\textbf{#1:} }{\par}
%%\numberwithin{equation}{section} %%%number the formula by section
%\newcommand{\ucite}[1]{$^{\mbox{\scriptsize \cite{#1}}}$}
%\def\QEDopen{{\setlength{\fboxsep}{0pt}\setlength{\fboxrule}{0.2pt}\fbox{\rule[0pt]{0pt}{1.3ex}\rule[0pt]{1.3ex}{0pt}}}} %Define hollow characters
%\def\QED{\QEDopen}



%%% The following is for inserting the code in our Report
...
%	frame=single,                   % adds a frame around the code, we have 2 Options: "shadowbox" & "single"
	frame=shadowbox,                %xleftmargin=2em,xrightmargin=2em, aboveskip=1em;
...
\def\QED{\QEDopen}
\newenvironment{proof}[1][\bf 证明]{\textbf{#1.} }{\QED}%{}
\newenvironment{question}[1][\bf\large 问题]{\noindent\textbf{#1:} }%{?\par}
%\def\QED{\QEDopen}
%\newenvironment{solution}[1][\bf 解答]{\textbf{#1.} }{\QED}


\title{\emph{VEM Theory Analysis}\\\textbf{The Poincar\'{e}-Friedrichs inequality on polygon and its applications}}
% Title
...
\tableofcontents
\newpage
%\numberwithin{equation}{section}    %number formula by section
